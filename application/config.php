...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => '2PTbMHyof0ACgcJ6O39eG1kldrza5uWj',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'redis' => [
        'host' => Env::get('redis.host', '127.0.0.1'),              // redis 主机地址
        'password' => Env::get('redis.password', ''),                   // redis 密码
        'port' => Env::get('redis.port', '6379'),                     // redis 端口
        'select' => Env::get('redis.select', 1),                      // redis 数据库
        'timeout' => Env::get('redis.timeout', 0),                     // redis 超时时间
        'persistent' => Env::get('redis.persistent', false),              // redis 持续性，连接复用
    ]
];
